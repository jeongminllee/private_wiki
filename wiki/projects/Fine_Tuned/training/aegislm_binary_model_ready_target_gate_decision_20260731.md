...
[ARVO Patch Gate 결정문](aegislm_binary_model_ready_target_gate_decision_20260731.md)에
보존한다.
...
- [Phase F 데이터셋 및 바이너리 실험 계획](aegislm_phase_f_experiment_plan_20260728.md)
- [파인튜닝 실행 기록](qwen3_coder_next_80b_2gpu_run_20260720.md)
- [Binary Role Target v2 결정](aegislm_binary_model_ready_target_gate_decision_20260731.md)
- [ARVO Patch Gate 결정](aegislm_binary_model_ready_target_gate_decision_20260731.md)
