...
## 1. 분석 대상(What)과 분석 방법(How)에 따른 4대 과제 발굴 유형

| 분석 대상 (What) \ 방법 (How) | 분석 방법 알고 있음 (Known) | 분석 방법 모름 (Unknown) |
| :--- | :--- | :--- |
| **분석 대상 알고 있음 (Known)** | **최적화 (Optimization)**<br>문제와 방식을 모두 알고 있어 프로세스 효율 극대화 | **솔루션 (Solution)**<br>문제는 명확히 아는데 해결 방법을 몰라 새로운 해법(Solution) 모색 |
| **분석 대상 모름 (Unknown)** | **통찰 (Insight)**<br>방법(기술/도구)은 아는데 분석 대상을 몰라 새로운 통찰(Insight) 도출 | **발견 (Discovery)**<br>대상과 방법 모두 불명확하여 탐색적 연구 및 과제 발견 |
